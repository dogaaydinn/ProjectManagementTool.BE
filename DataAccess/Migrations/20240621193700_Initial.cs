        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    DutyId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    TeamProjectId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DutyAccesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DutyAccesses_Duties_DutyId",
                        column: x => x.DutyId,
                        principalTable: "Duties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DutyAccesses_TeamProjects_TeamProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DutyAccesses_DutyId",
                table: "DutyAccesses",
                column: "DutyId");

            migrationBuilder.CreateIndex(
                name: "IX_DutyAccesses_TeamProjectId",
                table: "DutyAccesses",
